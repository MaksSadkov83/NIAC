...
@section('content')
    <form class="form_add_student" action="{{ route('update_examinee', ['id' => $id]) }}" method="POST" id="form_add_group">
        @csrf
        <h2 style="margin-bottom: 50px;">
            <span style="color: #3c8bff;">></span> Обновить пользователя (Экзаменующийся):
        </h2>
        ...
        <input type="hidden" value="Экзаменующийся" name="role_user" id="role_user">
